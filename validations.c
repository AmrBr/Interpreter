...
// Balances the Parentheses in the expression to make sure of correct evaluation
...
// Checks if the variable user entered is valid
...
// Validates the expression the user entered
